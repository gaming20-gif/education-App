...
import { User, GraduationCap, Award, BookOpen, Bookmark, Download, ShieldCheck, Mail, Calendar, Edit3, LogOut, Sparkles } from "lucide-react";
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Academic Bookmarks & Quick Downloads */}
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs space-y-4">
          <h2 className="text-base font-bold text-[#1E293B] flex items-center gap-2 border-b border-slate-100 pb-3">
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 rounded-xl border border-slate-200 bg-[#F8FAFC] flex items-center justify-between">
              ...
              <span className="font-semibold text-[#10B981]">Downloaded</span>
            </div>
