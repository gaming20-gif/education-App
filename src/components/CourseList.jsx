  ...
  return (
    <div className="space-y-6 animate-fade-in pb-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white border border-slate-200 p-3.5 sm:p-4 rounded-xl shadow-xs">
        ...
        <div className="px-2.5 py-1 rounded-full bg-amber-50 border border-amber-200 text-[#F59E0B] text-xs font-bold self-start sm:self-auto shrink-0 whitespace-nowrap flex items-center gap-1">
